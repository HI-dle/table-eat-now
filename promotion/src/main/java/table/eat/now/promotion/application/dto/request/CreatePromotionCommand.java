package table.eat.now.promotion.application.dto.request;

import java.math.BigDecimal;
import java.time.LocalDateTime;
import table.eat.now.promotion.domain.entity.Promotion;
import table.eat.now.promotion.domain.entity.PromotionStatus;
import table.eat.now.promotion.domain.entity.PromotionType;

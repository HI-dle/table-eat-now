...
class ReservationInternalControllerTest extends ControllerTestSupport {

  @DisplayName("예약 단건 조회 internal 컨트롤러")
  @Nested
  class GetReservationInternal {

    private static final String urlPrefix = "/internal/v1/reservations";
    ...
    void success(UserRole role) throws Exception {
      ...
      mockMvc.perform(get(urlPrefix + "/{reservationUuid}", reservationUuid)
          ...
          .andExpect(jsonPath("$.reserverId").value(1))

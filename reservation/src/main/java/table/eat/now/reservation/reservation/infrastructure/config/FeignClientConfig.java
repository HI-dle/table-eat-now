 ...
 * @Date : 2025. 04. 11.
 */
package table.eat.now.reservation.reservation.infrastructure.config;
...
@EnableFeignClients("table.eat.now.reservation.reservation.infrastructure.client.feign")

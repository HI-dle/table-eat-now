...
drop table if exists p_coupon cascade;
drop table if exists p_coupon_policy cascade;
drop table if exists p_user_coupon cascade;
drop sequence if exists p_user_coupon_seq;
